...
\reed{Lots of these come from Luke's walnut code. Is there something we can cite, or should we include him as an author or something?}
...
\reed{How many of these are interesting enough to include here}
...
\begin{theorem}
    ...
    \reed{this theorem makes the previous two about there being finitely many of each easy corollaries, so we could omit them if we choose/need space}
\end{theorem}
\begin{proof}
...
\reed{TODO: Add the new theorem we proved from https://arxiv.org/abs/2005.11718}
